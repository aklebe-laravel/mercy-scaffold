...
/**
 * This way you can define all names and tokens in env.
 * If a name or token is empty, the bot will not be listed in config.
 *
 * see automatic insert below
 */
$__tmpBotMap = [
    'TELEGRAM_BOT_NAME_FREIHEIT'   => 'TELEGRAM_BOT_TOKEN_FREIHEIT',
    'TELEGRAM_BOT_NAME_LOCAL_DEV1' => 'TELEGRAM_BOT_TOKEN_LOCAL_DEV1',
    'TELEGRAM_BOT_NAME_LOCAL_DEV2' => 'TELEGRAM_BOT_TOKEN_LOCAL_DEV2',
    'TELEGRAM_BOT_NAME_DEV'        => 'TELEGRAM_BOT_TOKEN_DEV',
    'TELEGRAM_BOT_NAME_INT'        => 'TELEGRAM_BOT_TOKEN_INT',
    'TELEGRAM_BOT_NAME_PROD'       => 'TELEGRAM_BOT_TOKEN_PROD',
];
...
$__tmpResult = [
    ...
    |             ]
    */
    'bots'                         => [], // FILLED BELOW DEPENDS ON MAP ABOVE
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Bot update cache ttl
    |--------------------------------------------------------------------------
    |
    | Cache TTL for new requesting all bots.
    |
    */
    'bots_update_ttl'              => env('TELEGRAM_BOTS_UPDATE_CACHE_TTL', 10),
...
foreach ($__tmpBotMap as $__k => $__v) {
    if (($__envName = env($__k)) && ($__envValue = env($__v))) {
        $__tmpResult['bots'][$__envName] = [
            'token'            => $__envValue,
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', ''),
            'webhook_url'      => env('TELEGRAM_WEBHOOK_URL', ''),
            'commands'         => [//Acme\Project\Commands\MyTelegramBot\BotCommand::class
            ],
        ];
    }
}
